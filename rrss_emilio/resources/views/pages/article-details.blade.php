...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <!-- <a class="navbar-brand logo-text page-scroll" href="welcome.blade.php">Tivo</a> -->

            <!-- Image Logo -->
            <a class="navbar-brand logo-image" href="welcome.blade.php"><img src="images/logo.svg" alt="alternative"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="welcome.blade.php#header">HOME <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="welcome.blade.php#features">FEATURES</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="welcome.blade.php#details">DETAILS</a>
                    </li>

                    <!-- Dropdown Menu -->
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle page-scroll" href="welcome.blade.php#video" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">VIDEO</a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="welcome.blade.php#pricing">PRICING</a>
                    </li>
                </ul>
                <span class="nav-item">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="welcome.blade.php">Home</a><i class="fa fa-angle-double-right"></i><span>Longer Project Title Should Go Here</span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a class="btn-outline-reg" href="welcome.blade.php">BACK</a>
                </div> <!-- end of col-->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
